...
from fairseq.tasks.translation import load_langpair_dataset, load_langtriple_dataset
...
class STbertPretrainingConfig(FairseqDataclass):
    ...
    add_decoder: bool = field(
        default=True,
        metadata={"help": "contral the model architecture"},
    )
...
@register_task("joint_sc2t_pretraining", dataclass=STbertPretrainingConfig)
