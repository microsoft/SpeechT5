...
class TransformerEncoderLayer(TransformerEncoderLayerBase):
    def __init__(self, args, has_relative_attention_bias=False, scaling_for_att=1.0):
        super().__init__(
    ...
    def build_self_attention(self, embed_dim, args, has_relative_attention_bias=False, scaling_for_att=1.0):
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def __init__(
        ...
        if no_encoder_attn:
            ...
            self.encoder_attn = self.build_encoder_attention(self.embed_dim, cfg, scaling_for_att=scaling_for_att)
    ...
    def build_self_attention(
        self, embed_dim, cfg, add_bias_kv=False, add_zero_attn=False, has_relative_attention_bias=False, scaling_for_att=1.0,
    ):
        return MultiheadAttention(
            embed_dim,
    ...
    def build_encoder_attention(self, embed_dim, cfg, scaling_for_att=1.0):
        return MultiheadAttention(
            embed_dim,
            cfg.decoder.attention_heads,
...
class TransformerDecoderLayer(TransformerDecoderLayerBase):
    def __init__(
        self, args, no_encoder_attn=False, add_bias_kv=False, add_zero_attn=False, has_relative_attention_bias=False, scaling_for_att=1.0,
    ):
        super().__init__(
            TransformerConfig.from_namespace(args),
    ...
    def build_self_attention(
        self, embed_dim, args, add_bias_kv=False, add_zero_attn=False, has_relative_attention_bias=False, scaling_for_att=1.0,
    ):
        return super().build_self_attention(
            embed_dim,
            TransformerConfig.from_namespace(args),
    ...
    def build_encoder_attention(self, embed_dim, args, scaling_for_att=1.0,):
