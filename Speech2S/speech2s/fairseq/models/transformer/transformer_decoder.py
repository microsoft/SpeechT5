...
class TransformerDecoderBase(FairseqIncrementalDecoder):
    ...
    def build_decoder_layer(self, cfg, no_encoder_attn=False):
        layer = transformer_layer.TransformerDecoderLayerBase(cfg, no_encoder_attn, has_relative_attention_bias=self.use_rel_pos_enc, scaling_for_att=self.scaling_for_att)
