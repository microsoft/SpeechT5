...
python $CODE_ROOT/fairseq/fairseq_cli/hydra_train.py \
  ...
  checkpoint.restore_file="/mnt/default/v-ziqzhang/data/speechut/exp/pretrain/base_speechut4asr_32gpu_1accum/checkpoint_298_400000.pt" \


# DATA_DIR=/mnt/default/v-ziqzhang/data/stbert/data/librispeech/hubert_release_iter2_layer9_kmeans/local
# TEXT_DATA_DIR=/mnt/default/v-ziqzhang/dataset/librispeech_lm_char/bin-idx
